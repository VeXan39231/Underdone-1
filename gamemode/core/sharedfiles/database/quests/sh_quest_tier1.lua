...
Quest.Story = "Dr. Breen is a pain in the ass for us rebels.  Kill him slowly so he suffers a terrible death in our hands. I'll reward you with money and amazing shoulder-pads."
Quest.Level = 50
Quest.Kill = {}
Quest.Kill["Breen"] = 1
...
Quest.GainedItems["armor_shoulder_bio"] = 1
Register.Quest(Quest)
...
local Quest = {}
Quest.Name = "quest_killvorts4"
Quest.PrintName = "Kill vortigaunts 4"
Quest.Story = "Aliens? In my Earth? It's more likely than you think. Get rid of these horrible things for the last time!"
Quest.Level = 25
Quest.Kill = {}
Quest.Kill["vortigaunt"] = 30
Quest.GainedExp = 550
Quest.GainedItems = {}
Quest.GainedItems["money"] = 1100
Quest.GainedItems[""] = 
Register.Quest(Quest)
